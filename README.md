...
[![Testing](https://github.com/wp-cli/media-command/actions/workflows/testing.yml/badge.svg)](https://github.com/wp-cli/media-command/actions/workflows/testing.yml) [![Build Status](https://travis-ci.org/wp-cli/media-command.svg?branch=main)](https://travis-ci.org/wp-cli/media-command)
